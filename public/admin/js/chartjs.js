...
(function(window, document, $) {
    ...
    $(window).on("load", function () {
        ...
        var chartOptions = {
            ...
            scales: {
                ...
                yAxes: [{
                    ...
                    scaleLabel: {
                        display: true,
                        labelString: 'درصد فروش'
                    }
                }]
            },
            title: {
                display: true,
                text: 'آمار ماه های پر فروش'
            }
        };

        // Chart Data
        var chartData = {
            labels: ["اسفند","بهمن","دی","آذر","آّبان","مهر", "شهریور", "مرداد", "تیر ", "خرداد", "اردیبهشت", "فروردین"],
            datasets: [{
                label: "مجموعه اول من",
                data: [65, 59, 100, 81, 56, 55, 40,20,30,88,15,44],
                fill: false,
                // borderDash: [5, 5],
                borderColor: "#666ee8",
        ...
        // Create the chart
        var lineChart10 = new Chart(ctx1, config);
    ...
    // Chart Data
    var chartData = {
        labels: ['زمان باقی مانده', 'تعداد استفاده شده', 'تعداد باقی مانده'],
        datasets: [{
            label: "مجموعه اول من",
            data: [350, 450, 100],
