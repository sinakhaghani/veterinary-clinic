...
window.addEventListener('livewire:load', function () {
  Livewire.on('validateLogin', function (type, message) {
    Swal.fire({
      icon: type,
      title: message,
      text: '',
