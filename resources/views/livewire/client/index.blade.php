            ...
            <div class="col-lg-4 col-md-6">
                <div class="single_service">
                    ...
                    <div class="service_content text-center">
                        <h3>@lang('messages.index.service_area.title_first')</h3>
                        <p>@lang('messages.index.service_area.text_first')</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="single_service active">
                    ...
                    <div class="service_content text-center">
                        <h3>@lang('messages.index.service_area.title_second')</h3>
                        <p>@lang('messages.index.service_area.text_second')</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="single_service">
                    ...
                    <div class="service_content text-center">
                        <h3>@lang('messages.index.service_area.title_third')</h3>
                        <p>@lang('messages.index.service_area.text_third')</p>
                    </div>
                </div>
            </div>
        </div>
